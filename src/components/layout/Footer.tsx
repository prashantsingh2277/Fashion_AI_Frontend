  ...
  return (
    <footer className="border-t border-gray-200/80 bg-white/50 backdrop-blur-sm">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="text-xl font-bold tracking-tighter">
              Fashion<span className="text-blue-600">AI</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/ai-outfit-generator" className="text-gray-600 hover:text-blue-600 transition-colors">
                  AI Outfit Generator
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200/80 flex flex-col md:flex-row items-center justify-between">
